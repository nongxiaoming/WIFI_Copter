...
void ANO_UART1::Uart1_Init(u32 br_num)
{
...
void ANO_UART1::Uart1_Put_String(unsigned char *Str)
{
	//判断Str指向的数据是否有效.
	while(*Str)
	{
...
void ANO_UART1::Uart1_Put_Buf(unsigned char *DataToSend , u8 data_num)
{
