...
class XSkinManager : public QWidget
{
	Q_OBJECT

public:

    explicit XSkinManager(QWidget *parent = 0);
...
private:
    ...
    XSkinItem *skin_item_0;
    XSkinItem *skin_item_1;
    XSkinItem *skin_item_2;
    XSkinItem *skin_item_3;
    XSkinItem *skin_item_4;
    XSkinItem *skin_item_5;
    XSkinItem *skin_item_6;
    XSkinItem *skin_item_7;
