...
void XSkinManager::showSkin(QString current_skin)
{
    ...
    skin_item_0->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_1->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_2->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_3->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_4->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_5->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_6->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
    skin_item_7->changeSkin(":/skin/"+ QString::number(previous_total_page++, 10), tip_list.at(tip_index++), "11");
}
