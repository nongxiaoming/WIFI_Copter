...
void PrimaryFlightDisplay::checkUpdate()
{
    ...
    if ((_valuesChanged || ( time- _valuesLastPainted) > 260)) {
        update();
        _valuesChanged = false;
        _valuesLastPainted = time;
    }
}

void PrimaryFlightDisplay::forgetUAS()
{
 ...
 */
void PrimaryFlightDisplay::setActiveUAS()
{
//    if (uas == this->uas)
...
void PrimaryFlightDisplay::updateAttitude( double roll, double pitch, double yaw, quint64 timestamp)
{
    Q_UNUSED(timestamp);
...
void PrimaryFlightDisplay::updateAttitude( int component, double roll, double pitch, double yaw, quint64 timestamp)
{
    Q_UNUSED(component);
    this->updateAttitude(roll, pitch, yaw, timestamp);
}

void PrimaryFlightDisplay::updateSpeed( double _groundSpeed, double _airSpeed, quint64 timestamp)
{
    Q_UNUSED(timestamp);
...
void PrimaryFlightDisplay::updateAltitude( double _altitudeAMSL, double _altitudeRelative, double _climbRate, quint64 timestamp) {
...
void PrimaryFlightDisplay::updateNavigationControllerErrors( double altitudeError, double speedError, double xtrackError) {
