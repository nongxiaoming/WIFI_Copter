...
public slots:
    ...
    void updateSpeed( double _groundSpeed, double _airSpeed, quint64 timestamp);
    void updateAltitude(double _altitudeAMSL, double _altitudeRelative, double _climbRate, quint64 timestamp);
