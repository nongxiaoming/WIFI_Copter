    ...
    , vboEnable(false)
{
    ...
    setAcFilename("models/easystar.3ds");
    setVboEnable(false);
    CreateScene();
...
void ModelViewWidget::setAcFilename(QString acf)
{
    if (QFile::exists(acf)) {
        acFilename = acf;
    } else {
        acFilename = acf = ":/models/quad_X.3ds";
        m_GlView.cameraHandle()->setFrontView(); // set to front camera to see/read the warning sign
    }
}

void ModelViewWidget::setBgFilename(QString bgf)
{
...
void ModelViewWidget::setVboEnable(bool eVbo)
{
    vboEnable = eVbo;
...
//// Public funcitons ////
void ModelViewWidget::reloadScene()
{
    CreateScene();
}
...
void ModelViewWidget::CreateScene()
{
...
void ModelViewWidget::wheelEvent(QWheelEvent *e)
{
...
void ModelViewWidget::mousePressEvent(QMouseEvent *e)
{
...
void ModelViewWidget::mouseMoveEvent(QMouseEvent *e)
{
    GLC_UserInput userInput(e->x(), e->y());
...
void ModelViewWidget::keyPressEvent(QKeyEvent *e) // switch between camera
{
    if (e->key() == Qt::Key_1) {
...
//////////////////////////////////////////////////////////////////////
void ModelViewWidget::updateAttitude()
{
